...
public class PlayerStatsHandler : MonoBehaviour
{
    ...
    public PlayerStats CurrentStat { get; private set; } = new();
    ...
    private void UpdateCharacterStat()
    {
        ...
        baseStats.maxHealth += 10 * itemData.itemstack[2];
        baseStats.speed += 10 * itemData.itemstack[1];
    ...
    private void UpdateBasicStats(Func<float, float, float> operation, PlayerStats modifier)
    {
    ...
    private void UpdateAttackStats(Func<float, float, float> operation, PlayerStats modifier)
    {
